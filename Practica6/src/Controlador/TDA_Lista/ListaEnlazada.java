...
public class ListaEnlazada<E> {
    ...
    /**
     * Metodo que permite obtener un verificar segun la posicion
     *
     ...
     *
     * @param clazz El tipo de clase q permite identificar q tipo de verificar es
     ...
     * @param auxJ verificar en la posicion J
     * @param auxJ1 verificar en la posicion J + 1
     ...
     * @param dato El verificar a buscar
